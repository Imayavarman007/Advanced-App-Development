                ...
                <Container maxW={'5xl'}>
                    ...
                    >
                        ...
                        <Text color={!isDarkMode ? 'black' : 'gray.100'}>
                            {/* {content} */}
                            Welcome to our Student Enquiry Assistance Portal, your one-stop destination for all queries related to academic pursuits, support services, and extracurricular activities. Designed with students in mind, our platform aims to provide comprehensive assistance to help you navigate through your educational journey seamlessly.
                        </Text>
                        <Stack
                            direction={'column'}
                            spacing={3}
